...
public interface ProductMapper {
    ...
    RetirementPensionEsEntity toRetirementPensionEsEntity(RetirementPensionProductEntity entity);
    ...
    RetirementPensionProductEntity toRetirementPensionProductEntity(RetirementPensionProductDto dto, ProductArea productArea, SysType sysType);
