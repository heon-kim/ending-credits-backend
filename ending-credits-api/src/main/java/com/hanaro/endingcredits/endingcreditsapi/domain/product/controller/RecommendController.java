...
public class RecommendController {
    ...
    public ApiResponseEntity<PensionSavingsResponseComparisonDto> recommendProduct(@RequestParam String strategyName) {
        try {
            // 문자열을 Strategy Enum으로 변환
            Strategy strategy = Strategy.fromDescription(strategyName);

            // 추천된 상품 반환
            PensionSavingsResponseComparisonDto recommendedProduct = recommendService.recommendProduct(strategy);
