...
//    }
    ...
    @GetMapping("/annuity/detail/{companyYieldId}")
    public ApiResponseEntity<RetirementPensionDetailResponseDto> getPensionProductDetailById(@PathVariable UUID companyYieldId) {
        try {
            RetirementPensionDetailResponseDto responseDto = retirementPensionService.getPensionProductDetailById(companyYieldId);
